...
const TermOfService = () => {
  return (
    <div className="font-sans flex flex-col text-black dark:text-white">
      <MyHelmet title={"Điều Khoản Dịch Vụ"} description={"Web tổng hợp và đọc tiểu thuyết trực tuyến"} />
      <Slider />
      ...
      <div className="flex flex-col gap-8 text-[1.05rem] px-1 text-justify">
        ...
        <p>
          Quy định này áp dụng cho mọi đối tượng tham gia hoạt động tại website, không kể là khách, thành viên, tác giả,
          dịch giả, biên tập viên, quản trị viên, admin hay bất cứ thành viên nào khác.
        </p>
        ...
        <ul className="list-decimal ps-6 text-justify flex flex-col gap-2">
          ...
          <li>
            Không phát tán và truyền bá thông tin bất hợp pháp, lừa gạt, bôi nhọ, sỉ nhục, tục tĩu, khiêu dâm, xúc phạm,
            đe dọa, lăng mạ, thù hận, kích động… hoặc trái với chuẩn mực đạo đức chung của xã hội.
          </li>
          <li>
            Không được gửi hoặc truyền bất kỳ thông tin hoặc phần mềm nào có chứa bất kỳ loại virus, trojan, bọ hay các
            thành phần nguy hại nào đến sự an toàn của hệ thống dịch vụ.
          </li>
