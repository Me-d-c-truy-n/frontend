...
const Header = () => {
  ...
  return (
    <div className={`flex justify-between items-center pt-2 mb-1`}>
      ...
      <div
        className={`bg-transparent border-slate-300 flex items-center w-72 md:w-96 border p-2 ps-5 rounded-full shadow-sm outline-none ${isSelected ? "border-amber-500" : ""}`}
      >
        <input
          className={`dark:text-slate-200 bg-transparent outline-none w-11/12`}
        ...
        />
        <CiSearch className="text-xl text-amber-600 font-bold cursor-pointer" onClick={handleSearch} />
      </div>
      <button
