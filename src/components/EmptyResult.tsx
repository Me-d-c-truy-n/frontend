      ...
      <div className="grid gap-4">
        ...
        >
          <path
            ...
            fill={theme == THEME.LIGHT ? "#EEF2FF" : "#2a2a2b"}
          />
          <path
            ...
            fill={theme == THEME.LIGHT ? "white" : "#3d3d3d"}
            stroke={theme == THEME.LIGHT ? "#E5E7EB" : "#19191a"}
          />
          <ellipse cx="80.0618" cy="81" rx="28.0342" ry="28.0342" fill={theme == THEME.LIGHT ? "#EEF2FF" : "#36363f"} />
          <path
          ...
          <path
            ...
            fill="#FF6500"
          />
          <rect x="38.3522" y="21.5128" width="41.0256" height="2.73504" rx="1.36752" fill="#FF6500" />
          <rect x="38.3522" y="133.65" width="54.7009" height="5.47009" rx="2.73504" fill="#f7be7c" />
          <rect x="38.3522" y="29.7179" width="13.6752" height="2.73504" rx="1.36752" fill="#FF6500" />
          <circle cx="56.13" cy="31.0854" r="1.36752" fill="#FF6500" />
          <circle cx="61.6001" cy="31.0854" r="1.36752" fill="#FF6500" />
          <circle cx="67.0702" cy="31.0854" r="1.36752" fill="#FF6500" />
        </svg>
        <div>
          <h2 className="uppercase text-center text-amber-600 text-lg md:text-2xl font-semibold leading-loose">
            {title}
          </h2>
        </div>
      </div>
