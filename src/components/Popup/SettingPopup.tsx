    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-10">
          ...
          <GrClose
            className="text-xl cursor-pointer text-gray-500 hover:text-black dark:hover:text-slate-400"
            onClick={close}
          />
        </div>
        ...
        <div className="flex justify-between mb-4">
          <div>Màu chữ</div>
          <input type="color" value={color} className="w-32" onChange={(e) => setColor(e.target.value)} />
        </div>
        <div className="flex justify-between mb-4">
          <div>Cỡ chữ</div>
          <CustomSelection
        ...
        <div className="flex items-center justify-center">
          <button onClick={resetSettings} className="text-slate-600 px-4 py-1 rounded-md bg-white">
            Mặc định
          </button>
        </div>
      </div>
