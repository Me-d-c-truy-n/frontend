...
- [1 Source file basics](#2-source-file-basics)
  - [1.2 File name](#22-file-name)
  - [1.3 File encoding](#23-file-encoding)
- [2 Source file structure](#3-source-file-structure)
  - [2.1 License or copyright information](#31-license-or-copyright-information)
  - [2.2 Package statement](#32-package-statement)
    - [2.2.1 No line-wrapping](#321-no-line-wrapping)
  - [2.3 Import statements](#33-import-statements)
    - [2.3.1 No wildcard imports](#331-no-wildcard-imports)
    - [2.3.2 No line-wrapping](#332-no-line-wrapping)
    - [2.3.3 Ordering and spacing](#333-ordering-and-spacing)
  - [2.4 Class and Interface declaration](#34-class-and-interface-declaration)
    - [2.4.1 One top-level class declaration](#341-one-top-level-class-declaration)
    - [2.4.2 Class member ordering](#342-class-member-ordering)
    - [2.4.3 Overloads: never split](#343-overloads-never-split)
- [3 Formatting](#4-formatting)
  - [3.1 Indentation](#41-indentation)
    - [3.1.1 Alignement using 4 spaces](#411-alignement-using-4-spaces)
    - [3.1.2 Why not using tabs/smartab?](#412-why-not-using-tabssmartab)
  - [3.2 Lines](#42-lines)
    - [3.2.1 Line length](#421-line-length)
    - [3.2.2 Wrapping lines](#422-wrapping-lines)
  - [3.3 Braces](#43-braces)
    - [3.3.1 Nonempty blocks](#431-nonempty-blocks)
    - [3.3.2 Empty blocks](#432-empty-blocks)
  - [3.4 Whitespace](#44-whitespace)
    - [3.4.1 Vertical Whitespace](#441-vertical-whitespace)
    - [3.4.2 Horizontal whitespace](#442-horizontal-whitespace)
    - [3.4.3 Horizontal alignment](#443-horizontal-alignment)
  - [3.5 Declarations](#45-declarations)
    - [3.5.1 Variables](#451-variables)
      - [3.5.1.1 One variable per declaration](#4511-one-variable-per-declaration)
      - [3.5.1.2 Initialization](#4512-initialization)
    - [3.5.2 Classes and Interfaces](#452-classes-and-interfaces)
  - [3.6 Statements](#46-statements)
    - [3.6.1 Simple statements](#461-simple-statements)
    - [3.6.2 Compound statements](#462-compound-statements)
    - [3.6.3 `return` statements](#463-return-statements)
    - [3.6.4 `if`, `if-else`, `if else-if else` statements](#464-if-if-else-if-else-if-else-statements)
    - [3.6.5 `for` statements](#465-for-statements)
    - [3.6.6 `while` statements](#466-while-statements)
    - [3.6.7 `do-while` statements](#467-do-while-statements)
    - [3.6.8 `switch` statements](#468-switch-statements)
      - [3.6.8.1 Indentation](#4681-indentation)
      - [3.6.8.2 Fall-through: commented](#4682-fall-through-commented)
      - [3.6.8.3 Default case](#4683-default-case)
    - [3.6.9 `try-catch` statements](#469-try-catch-statements)
  - [3.7 Specific constructs](#47-specific-constructs)
    - [3.7.1 Enum classes](#471-enum-classes)
    - [3.7.2 Annotations](#472-annotations)
    - [3.7.3 Arrays](#473-arrays)
      - [3.7.3.1 Array initializers](#4731-array-initializers)
      - [3.7.3.2 No C-style array declarations](#4732-no-c-style-array-declarations)
    - [3.7.4 Comments](#474-comments)
    - [3.8 Modifiers](#48-modifiers)
    - [3.9 Numeric Literals](#49-numeric-literals)
    - [3.10 Runtime Exception](#410-runtime-exception)
- [4 Naming](#5-naming)
  - [4.1 Common to all identifiers](#51-common-to-all-identifiers)
  - [4.2 By indentifier type](#52-by-indentifier-type)
    - [4.2.1 Package names](#521-package-names)
    - [4.2.2 Class names](#522-class-names)
    - [4.2.3 Method names](#523-method-names)
    - [4.2.4 Constant names](#524-constant-names)
    - [4.2.5 Non-constant field names](#525-non-constant-field-names)
    - [4.2.6 Parameter names](#526-parameter-names)
    - [4.2.7 Local variable names](#527-local-variable-names)
    - [4.2.8 Type variable names](#528-type-variable-names)
  - [4.3 Camel case](#53-camel-case)
- [5 Programming Practices](#6-programming-practices)
  - [5.1 Avoid public class members](#61-avoid-public-class-members)
  - [5.2 Static members: qualified using class](#62-static-members-qualified-using-class)
  - [5.3 Variable Assignments](#63-variable-assignments)
  - [5.4 Grouping parentheses](#64-grouping-parentheses)
  - [5.5 Returning Values](#65-returning-values)
  - [5.6 Expressions before '?' in the Conditional Operator](#66-expressions-before--in-the-conditional-operator)
  - [5.7 @Override: always used](#67-@override-always-used)
  - [5.8 Caught exceptions](#68-caught-exceptions)
- [6 Javadoc](#7-javadoc)
  - [6.1 Formatting](#71-formatting)
    - [6.1.1 General form](#711-general-form)
    - [6.1.2 Paragraphs](#712-paragraphs)
    - [6.1.3 At-clauses](#713-at-clauses)
  - [6.2 The summary fragment](#72-the-summary-fragment)
  - [6.3 Where Javadoc is used](#73-where-javadoc-is-used)
    - [6.3.1 Exception: self-explanatory methods](#731-exception-self-explanatory-methods)
    - [6.3.2 Exception: overrides](#732-exception-overrides)
