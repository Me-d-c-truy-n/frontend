    ...
    <div className='font-sans flex flex-col text-black dark:text-white'>
      ...
      <div className='flex flex-col gap-8 text-[1.05rem] px-1 text-justify'>
        <ul className='list-decimal ps-6 text-justify flex flex-col gap-2'>
          ...
          <li>
            Nền tảng luôn cố gắng đảm bảo rằng tất cả nội dung trong hệ thống đều hợp pháp, nhưng chúng tôi không cam
            kết chắc chắn rằng có thể kiểm soát mọi thông tin trên ứng dụng.
          </li>
          <li>Nền tảng không đại diện cho nhóm dịch, người dịch là thành viên trên các website hệ thống.</li>
          <li>
            Nền tảng không có trách nhiệm truy cứu, kiện tụng và phân giải đối với các tác phẩm không do nền tảng sở hữu
            bản quyền.
          </li>
        </ul>
        <i className='text-lg'>
