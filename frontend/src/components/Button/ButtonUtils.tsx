...
const ButtonUtils = ({ de = true, func, children, count=0 }: Props) => {
  return (
    <div className={`relative outline-none shadow cursor-pointer rounded px-2 py-1 ${de?'border border-gray-700 hover:border-amber-700 hover:text-amber-700':'text-white bg-amber-700'}`} onClick={func}>
